            ...
            <div class="flex-auto p-6">
                ...
                <div class="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
                    <a href="#"
                        ...
                        <span
                            class="flex-shrink-0 text-3xl font-black lowercase tracking-tight opacity-100">KuroKitsune Store</span>
                    </a>
                </div>
                <!-- /Logo -->
                <h4 class="mb-2 font-medium text-gray-700 xl:text-xl">Welcome to KuroKitsune Store!</h4>
